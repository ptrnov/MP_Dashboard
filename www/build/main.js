...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_trip_service__ = __webpack_require__(147);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__home_home__ = __webpack_require__(57);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    ...
    */
    ...
    HomePage.prototype.ionViewDidEnter = function () {
        ...
        this.subscription2 = __WEBPACK_IMPORTED_MODULE_10_rxjs_Observable__["Observable"].timer(3000, 3000).subscribe(function (x) {
            ...
            var getDataQry = _this.database.selectData(querySql);
            getDataQry.then(function (data) {
                var aryRslt = [];
                var ary_Header = [];
                var aryB2S_AREA = [];
                setTimeout(function () {
                    ...
                    // ObjHdr0.innerText='1';//ary_Header[0].isa?ary_Header[0][1].NILAI + " %":"0%";
                    // ObjHdr1.innerText='1';//ary_Header[0][2].NILAI!=null?ary_Header[0][2].NILAI + " %":"0%";
                    // ObjHdr2.innerText='1';//[0][3].NILAI!=null?ary_Header[0][3].NILAI + " %":"0%";
                    // ObjHdr3.innerText='1';//[0][4].NILAI!=null?ary_Header[0][4].NILAI + " %":"0%";
                    // // console.log(ary_Header[0][1].NILAI);
