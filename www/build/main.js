...
var Dsh2HomePage = (function () {
    ...
    Dsh2HomePage.prototype.dsh2_InitChart = function () {
        ...
        charting = __WEBPACK_IMPORTED_MODULE_3_highcharts__["chart"]({
            chart: {
...
var Dsh3HomePage = (function () {
    ...
    Dsh3HomePage.prototype.updateDataChart = function () {
        var rsltAryChart = [];
        var querySql = "SELECT DISTINCT ID_CHART,BULAN,TAHUN,NM_CHART,TITLE,CATEGORIES,TARGET_RFI,ACTUAL_RFI,TARGET,ACTUAL FROM TBL_CHART " // WHERE GRP='test' "
            + " WHERE ID_CHART='mp001' AND BULAN='09' AND TAHUN='2018'";
        // ?+" ORDER BY SEQ,GRP DESC,URUTAN ASC";
    ...
    Dsh3HomePage.prototype.initChart = function () {
        var tgl = new Date();
        var monthNames = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];
        charting = __WEBPACK_IMPORTED_MODULE_3_highcharts__["chart"]({
            chart: {
...
var HomePage = (function () {
    ...
    */
    ...
    HomePage.prototype.dsh1_InitChart = function () {
        var tgl = new Date();
        var monthNames = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];
        charting = __WEBPACK_IMPORTED_MODULE_9_highcharts__["chart"]({
            chart: {
