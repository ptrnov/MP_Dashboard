...
var Dsh2HomePage = (function () {
    function Dsh2HomePage(navCtrl, navParams, database, dashboarAll) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.database = database;
        this.dashboarAll = dashboarAll;
    ...
    Dsh2HomePage.prototype.dsh2_getData = function () {
        var ary_Header = [];
        var rsltAry = [];
        var grpB2S = [];
    ...
    Dsh2HomePage.prototype.dsh2_initMap = function (qryWhere) {
    ...
    Dsh2HomePage.prototype.dsh2_UpdateDataChart = function () {
        ...
        // ?+" ORDER BY SEQ,GRP DESC,URUTAN ASC";
        this.database.selectData(dsh2_querySql).then(function (data) {
            dsh2_rsltAryChart = [];
            dsh2_aryTarget_RFI = [];
            dsh2_aryActual_RFI = [];
            dsh2_aryTarget = [];
...
var Dsh3HomePage = (function () {
    function Dsh3HomePage(navCtrl, navParams, database, dashboarAll) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.database = database;
        this.dashboarAll = dashboarAll;
    ...
    Dsh3HomePage.prototype.ionViewDidEnter = function () {
        // this.menu.swipeEnable(false);
    ...
    Dsh3HomePage.prototype.dsh3_UpdateDataChart = function () {
        ...
        // ?+" ORDER BY SEQ,GRP DESC,URUTAN ASC";
        this.database.selectData(dsh3_querySql).then(function (data) {
            dsh3_rsltAryChart = [];
            dsh3_aryTarget_RFI = [];
            dsh3_aryActual_RFI = [];
            dsh3_aryTarget = [];
    ...
    Dsh3HomePage.prototype.dsh3_getData = function () {
        var ary_Header = [];
        var rsltAry = [];
        var grpCore = [];
        var areaNOT_RELEASE = [];
    ...
    Dsh3HomePage.prototype.dsh3_initMap = function (qryWhere) {
        if (qryWhere === void 0) { qryWhere = null; }
        var mapOptions = {
            zoom: 4,
            center: new google.maps.LatLng(-2.209764, 117.114258),
...
var Dsh4HomePage = (function () {
    function Dsh4HomePage(navCtrl, navParams, database, dashboarAll) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.database = database;
        this.dashboarAll = dashboarAll;
    ...
    Dsh4HomePage.prototype.ionViewDidEnter = function () {
        // this.menu.swipeEnable(false);
    ...
    Dsh4HomePage.prototype.dsh4_GetData = function () {
        var ary_Header = [];
        var rsltAry = [];
        var grpMCP = [];
        var area_NOT_RELEASE = [];
    ...
    Dsh4HomePage.prototype.map4_initMap = function (qryWhere) {
        if (qryWhere === void 0) { qryWhere = null; }
        var mapOptions = {
            zoom: 4,
            center: new google.maps.LatLng(-2.209764, 117.114258),
    ...
    Dsh4HomePage.prototype.dsh4_UpdateDataChart = function () {
        ...
        // ?+" ORDER BY SEQ,GRP DESC,URUTAN ASC";
        this.database.selectData(dsh4_querySql).then(function (data) {
            dsh4_rsltAryChart = [];
            dsh4_aryTarget_RFI = [];
            dsh4_aryActual_RFI = [];
            dsh4_aryTarget = [];
...
var Dsh5HomePage = (function () {
    function Dsh5HomePage(navCtrl, navParams, database, dashboarAll) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.database = database;
        this.dashboarAll = dashboarAll;
    ...
    Dsh5HomePage.prototype.ionViewDidEnter = function () {
        // this.menu.swipeEnable(false);
    ...
    Dsh5HomePage.prototype.dsh5_getData = function () {
        var ary_Header = [];
        var rsltAry = [];
        var grpSP = [];
        var area_NOT_RELEASE = [];
    ...
    Dsh5HomePage.prototype.dsh5_initMap = function (qryWhere) {
        if (qryWhere === void 0) { qryWhere = null; }
        var mapOptions = {
            zoom: 4,
            center: new google.maps.LatLng(-2.209764, 117.114258),
    ...
    Dsh5HomePage.prototype.dsh5_UpdateDataChart = function () {
        ...
        // ?+" ORDER BY SEQ,GRP DESC,URUTAN ASC";
        this.database.selectData(dsh5_querySql).then(function (data) {
            dsh5_rsltAryChart = [];
            dsh5_aryTarget_RFI = [];
            dsh5_aryActual_RFI = [];
            dsh5_aryTarget = [];
...
var DashboardAllProvider = (function () {
    ...
    */
    DashboardAllProvider.prototype.getMapCore = function () {
        var _this = this;
        // var x1=this.http.get(this.url + "/dashboard/get_chart_project_summary").map(res => res.json());
        var x1 = this.http.get(this.url + "Mobile_Dashboard/mapcore").map(function (res) { return res.json(); });
        x1.subscribe(function (data) {
            // var data=res.json();
...
var HomePage = (function () {
    function HomePage(
        ...
        navCtrl, popoverCtrl, dashboarAll, alertCtrl, modalCtrl, database, menu, loadingCtrl, config, events) {
        var _this = this;
        this.navCtrl = navCtrl;
    ...
    */
    ...
    HomePage = __decorate([
        ...
        __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["NavController"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["NavController"]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["PopoverController"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["PopoverController"]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_3__providers_dashboard_all_dashboard_all__["a" /* DashboardAllProvider */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__providers_dashboard_all_dashboard_all__["a" /* DashboardAllProvider */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["AlertController"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["AlertController"]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["ModalController"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["ModalController"]) === "function" && _e || Object, typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_4__providers_database_database__["a" /* DatabaseProvider */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__providers_database_database__["a" /* DatabaseProvider */]) === "function" && _f || Object, typeof (_g = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["MenuController"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["MenuController"]) === "function" && _g || Object, typeof (_h = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["LoadingController"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["LoadingController"]) === "function" && _h || Object, typeof (_j = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["Config"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["Config"]) === "function" && _j || Object, typeof (_k = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["Events"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["Events"]) === "function" && _k || Object])
    ], HomePage);
    return HomePage;
