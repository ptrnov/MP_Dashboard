...
var Dsh2HomePage = (function () {
    function Dsh2HomePage(navCtrl, navParams, database, dashboarAll, loadingCtrl) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.database = database;
        this.dashboarAll = dashboarAll;
    ...
    Dsh2HomePage.prototype.dsh2_UpdateCard = function () {
        var ary_Header = [];
        var rsltAry = [];
        var grpB2S = [];
...
var Dsh3HomePage = (function () {
    ...
    Dsh3HomePage.prototype.dsh3_UpdateCard = function () {
        var ary_Header = [];
        var rsltAry = [];
        var grpCore = [];
        var areaNOT_RELEASE = [];
...
var Dsh5HomePage = (function () {
    ...
    Dsh5HomePage.prototype.dsh5_UpdateCard = function () {
        var ary_Header = [];
        var rsltAry = [];
        var grpSP = [];
        var area_NOT_RELEASE = [];
