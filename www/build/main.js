...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__mock_trips__ = __webpack_require__(435);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_dashboard_all_dashboard_all__ = __webpack_require__(34);
...
var SettingsPage = (function () {
    function SettingsPage(platform, nav, dashboarAll, database, alertCtrl, events) {
    ...
    SettingsPage.prototype.filterTglChange = function ($event) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_rxjs_add_observable_interval__ = __webpack_require__(35);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_rxjs_add_observable_timer__ = __webpack_require__(36);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__settings_settings__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_highcharts__ = __webpack_require__(50);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_database_database__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_dashboard_all_dashboard_all__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_rxjs_add_observable_interval__ = __webpack_require__(35);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_rxjs_add_observable_timer__ = __webpack_require__(36);
...
var Dsh2HomePage = (function () {
    function Dsh2HomePage(navCtrl, navParams, database, dashboarAll, loadingCtrl, events, toastCtrl) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.database = database;
        this.dashboarAll = dashboarAll;
        ...
        /** Event date setting*/
        this.events.subscribe('filterTgl', function (data) {
    ...
    Dsh2HomePage.prototype.ngOnInit = function () {
        var _this = this;
        //Second Load DOM.
        ...
        setTimeout(function () {
            _this.dsh2_initCard();
            _this.dsh2_InitChart();
            _this.dsh2_initMap();
        }, 100);
        /** MAP */
        setTimeout(function () {
            _this.dsh2_UpdateCard();
            _this.dsh2_UpdateDataChart();
            _this.dsh2_UpdateDataMap();
        }, 200);
    };
    /** INIT CARD */
    Dsh2HomePage.prototype.dsh2_initCard = function () {
    ...
    Dsh2HomePage.prototype.dsh2_UpdateCard = function ($param) {
        var _this = this;
        if ($param === void 0) { $param = '0/0000'; }
        var ary_Header = [];
        var rsltAry = [];
        var grpB2S = [];
        ...
        //     rsltAry=[];
        //     rsltAry.push(data);
        this.dashboarAll.postDatax("Mobile_Dashboard/dshB2s/", $param).then(function (result) {
    ...
    Dsh2HomePage.prototype.dsh2_InitChart = function () {
        var dsh2_tgl = new Date();
        var dsh2_monthNames = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];
        dsh2_charting = __WEBPACK_IMPORTED_MODULE_3_highcharts__["chart"]({
            chart: {
    ...
    Dsh2HomePage.prototype.dsh2_UpdateDataChart = function () {
        var _this = this;
        this.loadingSpinner.present();
    ...
    Dsh2HomePage.prototype.rfiChange = function (event) {
        var objIndex;
        objIndex = mapArrayStt.findIndex((function (obj) { return obj.nama == "RFI"; }));
        mapArrayStt[objIndex].value = event['checked'];
        this.dsh2_UpdateDataMap(mapArrayStt);
    };
    Dsh2HomePage.prototype.releaseChange = function (event) {
        var objIndex;
        objIndex = mapArrayStt.findIndex((function (obj) { return obj.nama == "RELEASE"; }));
        mapArrayStt[objIndex].value = event['checked'];
        this.dsh2_UpdateDataMap(mapArrayStt);
    };
    Dsh2HomePage.prototype.notReleaseChange = function (event) {
        var objIndex;
        objIndex = mapArrayStt.findIndex((function (obj) { return obj.nama == "NOTRELEASE"; }));
        mapArrayStt[objIndex].value = event['checked'];
        this.dsh2_UpdateDataMap(mapArrayStt);
    };
    Dsh2HomePage.prototype.areaChange = function (event) {
        var objIndex;
        var intOption;
        intOption = event;
        objIndex = mapArrayStt.findIndex((function (obj) { return obj.nama == "AREA"; }));
        mapArrayStt[objIndex].value = intOption;
        this.dsh2_UpdateDataMap(mapArrayStt);
    };
    Dsh2HomePage.prototype.dsh2_initMap = function () {
        var mapOptions = {
            zoom: 4,
    ...
    Dsh2HomePage.prototype.dsh2_UpdateDataMap = function (qryWhere) {
        var _this = this;
        if (qryWhere === void 0) { qryWhere = null; }
        var rsltAryMap = [];
        var myRFI;
        var myRelease;
        var myNotRelease;
        ...
        this.database.selectObject(querySql).then(function (data) {
            _this.dsh2_spinnerPrepareMap.dismiss();
            _this.dsh2_spinnerPrepareMap.onDidDismiss(function () {
                _this.dsh2_spinnerSetMap = _this.loadingCtrl.create({
                    spinner: 'bubbles',
                    content: 'Copy maps data, Please wait...'
                });
                _this.dsh2_spinnerSetMap.present();
                setTimeout(function () {
                    if (data.length > 0) {
                        var dsh2_kondisi = 0;
                        data.forEach(function (el, index, array) {
                            ...
                            if (dsh2_kondisi == array.length) {
                                _this.dsh2_spinnerSetMap.dismiss();
                                _this.dsh2_spinnerSetMap.onDidDismiss(function () {
                                    var toastTutup = _this.toastCtrl.create({
                        ...
                        var toastBerhasil = _this.toastCtrl.create({
...
var Dsh3HomePage = (function () {
    function Dsh3HomePage(navCtrl, navParams, database, dashboarAll, loadingCtrl) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.database = database;
        this.dashboarAll = dashboarAll;
    ...
    /** First Innit Component  */
    Dsh3HomePage.prototype.ngOnInit = function () {
        var _this = this;
        //Second Load DOM.
        this.loadingSpinner.present();
        /** CHARTING */
        setTimeout(function () {
            _this.dsh3_initCard();
            _this.dsh3_InitChart();
            _this.dsh3_initMap();
        }, 50);
        /** MAP */
        setTimeout(function () {
            _this.dsh3_UpdateCard();
            _this.dsh3_UpdateDataChart();
            _this.dsh3_UpdateDataMap();
        }, 200);
    };
    /** INIT CARD */
    Dsh3HomePage.prototype.dsh3_initCard = function () {
        this.initMouseOverOut();
        this.initClickEvent();
    ...
    /** INIT CHART */
    Dsh3HomePage.prototype.dsh3_InitChart = function () {
        var tgl = new Date();
        var dsh3_monthNames = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];
        dsh3_charting = __WEBPACK_IMPORTED_MODULE_3_highcharts__["chart"]({
            chart: {
    ...
    Dsh3HomePage.prototype.dsh3_UpdateDataChart = function () {
        var _this = this;
        this.loadingSpinner.present();
        this.loadingSpinner.setContent("Load Chart");
        var dsh3_aryCtg = [];
    ...
    Dsh3HomePage.prototype.dsh3_UpdateCard = function ($param) {
        var _this = this;
        if ($param === void 0) { $param = '0/0000'; }
        var ary_Header = [];
        var rsltAry = [];
        ...
        //  rsltAry=[];
        //   rsltAry.push(data);
        this.dashboarAll.postDatax("Mobile_Dashboard/dshCore/", $param).then(function (result) {
            _this.responseData = result;
            console.log("length=", _this.responseData.length);
            rsltAry = [];
    ...
    Dsh3HomePage.prototype.rfiChange = function (event) {
        var objIndex;
        objIndex = mapArrayStt.findIndex((function (obj) { return obj.nama == "RFI"; }));
        mapArrayStt[objIndex].value = event['checked'];
        this.dsh3_UpdateDataMap(mapArrayStt);
    };
    Dsh3HomePage.prototype.releaseChange = function (event) {
        var objIndex;
        objIndex = mapArrayStt.findIndex((function (obj) { return obj.nama == "RELEASE"; }));
        mapArrayStt[objIndex].value = event['checked'];
        this.dsh3_UpdateDataMap(mapArrayStt);
    };
    Dsh3HomePage.prototype.notReleaseChange = function (event) {
        var objIndex;
        objIndex = mapArrayStt.findIndex((function (obj) { return obj.nama == "NOTRELEASE"; }));
        mapArrayStt[objIndex].value = event['checked'];
        this.dsh3_UpdateDataMap(mapArrayStt);
    };
    Dsh3HomePage.prototype.areaChange = function (event) {
        var objIndex;
        var intOption;
        intOption = event;
        objIndex = mapArrayStt.findIndex((function (obj) { return obj.nama == "AREA"; }));
    ...
    Dsh3HomePage.prototype.dsh3_initMap = function () {
        var mapOptions = {
            zoom: 4,
            center: new google.maps.LatLng(-2.209764, 117.114258),
            styles: this.database._defaultNewStyle
    ...
    Dsh3HomePage.prototype.dsh3_UpdateDataMap = function (qryWhere) {
        var _this = this;
        if (qryWhere === void 0) { qryWhere = null; }
        var rsltAryMap = [];
        var myRFI;
...
var Dsh4HomePage = (function () {
    function Dsh4HomePage(navCtrl, navParams, database, dashboarAll, loadingCtrl) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.database = database;
        this.dashboarAll = dashboarAll;
    ...
    /** First Innit Component  */
    Dsh4HomePage.prototype.ngOnInit = function () {
        var _this = this;
        //Second Load DOM.
        this.loadingSpinner.present();
        /** CHARTING */
        setTimeout(function () {
            _this.dsh4_initCard();
            _this.dsh4_InitChart();
            _this.dsh4_initMap();
        }, 100);
        /** MAP */
        setTimeout(function () {
            _this.dsh4_UpdateCard();
            _this.dsh4_UpdateDataChart();
            _this.dsh4_UpdateDataMap();
        }, 200);
    };
    /** INIT CARD */
    Dsh4HomePage.prototype.dsh4_initCard = function () {
        this.initMouseOverOut();
        this.initClickEvent();
    ...
    Dsh4HomePage.prototype.dsh4_UpdateCard = function ($param) {
        var _this = this;
        if ($param === void 0) { $param = '0/0000'; }
        var ary_Header = [];
        var rsltAry = [];
        ...
        //     rsltAry=[];
        //     rsltAry.push(data);
        this.dashboarAll.postDatax("Mobile_Dashboard/dshMcp/", $param).then(function (result) {
            _this.responseData = result;
            console.log("length=", _this.responseData.length);
            rsltAry = [];
    ...
    Dsh4HomePage.prototype.rfiChange = function (event) {
        var objIndex;
        objIndex = mapArrayStt.findIndex((function (obj) { return obj.nama == "RFI"; }));
        mapArrayStt[objIndex].value = event['checked'];
        this.dsh4_UpdateDataMap(mapArrayStt);
    };
    Dsh4HomePage.prototype.releaseChange = function (event) {
        var objIndex;
        objIndex = mapArrayStt.findIndex((function (obj) { return obj.nama == "RELEASE"; }));
        mapArrayStt[objIndex].value = event['checked'];
        this.dsh4_UpdateDataMap(mapArrayStt);
    };
    Dsh4HomePage.prototype.notReleaseChange = function (event) {
        var objIndex;
        objIndex = mapArrayStt.findIndex((function (obj) { return obj.nama == "NOTRELEASE"; }));
        mapArrayStt[objIndex].value = event['checked'];
        this.dsh4_UpdateDataMap(mapArrayStt);
    };
    Dsh4HomePage.prototype.areaChange = function (event) {
        var objIndex;
        var intOption;
        intOption = event;
        objIndex = mapArrayStt.findIndex((function (obj) { return obj.nama == "AREA"; }));
    ...
    Dsh4HomePage.prototype.dsh4_initMap = function () {
        var mapOptions = {
            zoom: 4,
            center: new google.maps.LatLng(-2.209764, 117.114258),
            styles: this.database._defaultNewStyle
    ...
    Dsh4HomePage.prototype.dsh4_UpdateDataMap = function (qryWhere) {
        var _this = this;
        if (qryWhere === void 0) { qryWhere = null; }
        var rsltAryMap = [];
        var myRFI;
    ...
    Dsh4HomePage.prototype.dsh4_UpdateDataChart = function () {
        var _this = this;
        this.loadingSpinner.present();
        this.loadingSpinner.setContent("Load Chart");
        var dsh4_aryCtg = [];
    ...
    Dsh4HomePage.prototype.dsh4_InitChart = function () {
        var dsh4_tgl = new Date();
        var dsh4_monthNames = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];
        dsh4_charting = __WEBPACK_IMPORTED_MODULE_3_highcharts__["chart"]({
            chart: {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ionic_native_sqlite__ = __webpack_require__(263);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_ionic_angular__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__tabel__ = __webpack_require__(425);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__setting__ = __webpack_require__(426);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__cardAll__ = __webpack_require__(427);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__mapStyle__ = __webpack_require__(428);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var DatabaseProvider = (function () {
    ...
    * ListUser send to html
    */
    DatabaseProvider.prototype.selectObject = function (querySql) {
        var _this = this;
        var aryRsltInternal = [];
        return new Promise(function (resolve, reject) {
            _this.platform.ready().then(function () {
...
var Dsh5HomePage = (function () {
    function Dsh5HomePage(navCtrl, navParams, database, dashboarAll, loadingCtrl) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.database = database;
        this.dashboarAll = dashboarAll;
    ...
    /** First Innit Component  */
    Dsh5HomePage.prototype.ngOnInit = function () {
        var _this = this;
        //Second Load DOM.
        this.loadingSpinner.present();
        /** CHARTING */
        setTimeout(function () {
            _this.dsh5_initCard();
            _this.dsh5_InitChart();
            _this.dsh5_initMap();
        }, 100);
        /** MAP */
        setTimeout(function () {
            _this.dsh5_UpdateCard();
            _this.dsh5_UpdateDataChart();
            _this.dsh5_UpdateDataMap();
        }, 200);
    };
    /** INIT CARD */
    Dsh5HomePage.prototype.dsh5_initCard = function () {
        this.initMouseOverOut();
        this.initClickEvent();
    ...
    Dsh5HomePage.prototype.dsh5_UpdateCard = function ($param) {
        var _this = this;
        if ($param === void 0) { $param = '0/0000'; }
        var ary_Header = [];
        var rsltAry = [];
        ...
        //     rsltAry=[];
        //     rsltAry.push(data);
        this.dashboarAll.postDatax("Mobile_Dashboard/dshSpl/", $param).then(function (result) {
            _this.responseData = result;
            console.log("length=", _this.responseData.length);
            rsltAry = [];
    ...
    Dsh5HomePage.prototype.rfiChange = function (event) {
        var objIndex;
        objIndex = mapArrayStt.findIndex((function (obj) { return obj.nama == "RFI"; }));
        mapArrayStt[objIndex].value = event['checked'];
        this.dsh5_UpdateDataMap(mapArrayStt);
    };
    Dsh5HomePage.prototype.releaseChange = function (event) {
        var objIndex;
        objIndex = mapArrayStt.findIndex((function (obj) { return obj.nama == "RELEASE"; }));
        mapArrayStt[objIndex].value = event['checked'];
        this.dsh5_UpdateDataMap(mapArrayStt);
    };
    Dsh5HomePage.prototype.notReleaseChange = function (event) {
        var objIndex;
        objIndex = mapArrayStt.findIndex((function (obj) { return obj.nama == "NOTRELEASE"; }));
        mapArrayStt[objIndex].value = event['checked'];
        this.dsh5_UpdateDataMap(mapArrayStt);
    };
    Dsh5HomePage.prototype.areaChange = function (event) {
        var objIndex;
        var intOption;
        intOption = event;
        objIndex = mapArrayStt.findIndex((function (obj) { return obj.nama == "AREA"; }));
    ...
    Dsh5HomePage.prototype.dsh5_initMap = function () {
        var mapOptions = {
            zoom: 4,
            center: new google.maps.LatLng(-2.209764, 117.114258),
            styles: this.database._defaultNewStyle
    ...
    Dsh5HomePage.prototype.dsh5_UpdateDataMap = function (qryWhere) {
        var _this = this;
        if (qryWhere === void 0) { qryWhere = null; }
        var rsltAryMap = [];
        var myRFI;
    ...
    Dsh5HomePage.prototype.dsh5_UpdateDataChart = function () {
        var _this = this;
        this.loadingSpinner.present();
        this.loadingSpinner.setContent("Load Chart");
        var dsh5_aryCtg = [];
    ...
    Dsh5HomePage.prototype.dsh5_InitChart = function () {
        var dsh5_tgl = new Date();
        var dsh5_monthNames = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];
        dsh5_charting = __WEBPACK_IMPORTED_MODULE_3_highcharts__["chart"]({
            chart: {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_dashboard_all_dashboard_all__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_database_database__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_highcharts__ = __webpack_require__(50);
...
var Dsh6HomePage = (function () {
    ...
    Dsh6HomePage.prototype.getCharting = function () {
        __WEBPACK_IMPORTED_MODULE_5_highcharts__["chart"]({
            chart: {
                renderTo: "chartDonut",
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_trip_service__ = __webpack_require__(151);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__home_home__ = __webpack_require__(61);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_trip_service__ = __webpack_require__(151);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__checkout_trip_checkout_trip__ = __webpack_require__(282);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs_add_operator_do__ = __webpack_require__(150);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs_add_operator_do___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_rxjs_add_operator_do__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_rxjs_add_observable_interval__ = __webpack_require__(35);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_rxjs_add_observable_timer__ = __webpack_require__(36);
...
var DashboardAllProvider = (function () {
    ...
    DashboardAllProvider.prototype.getAllPrj = function () {
        ...
        var x1 = this.http.get(this.url + "Mobile_Dashboard/dshAll/10/2018").map(function (res) { return res.json(); });
    ...
    * Author    : ptr.nov@gmail.com
    */
    DashboardAllProvider.prototype.getB2SPrj = function () {
        var _this = this;
        var x1 = this.http.get(this.url + "Mobile_Dashboard/b2sproject").map(function (res) { return res.json(); });
        x1.subscribe(function (data) {
            // var data=res.json();
    ...
    * Author    : ptr.nov@gmail.com
    */
    DashboardAllProvider.prototype.getCorePrj = function () {
        var _this = this;
        var x1 = this.http.get(this.url + "Mobile_Dashboard/coreproject").map(function (res) { return res.json(); });
        x1.subscribe(function (data) {
            // var data=res.json();
    ...
    * Author    : ptr.nov@gmail.com
    */
    DashboardAllProvider.prototype.getMcpPrj = function () {
        var _this = this;
        var x1 = this.http.get(this.url + "Mobile_Dashboard/microcellproject").map(function (res) { return res.json(); });
        x1.subscribe(function (data) {
            // var data=res.json();
    ...
    * Author    : ptr.nov@gmail.com
    */
    DashboardAllProvider.prototype.getSpPrj = function () {
        var _this = this;
        var x1 = this.http.get(this.url + "Mobile_Dashboard/specialproject").map(function (res) { return res.json(); });
        x1.subscribe(function (data) {
            // var data=res.json();
    ...
    * Author    : ptr.nov@gmail.com
    */
    DashboardAllProvider.prototype.getChartData = function () {
        var _this = this;
        // var x1=this.http.get(this.url + "/dashboard/get_chart_project_summary").map(res => res.json());
        var x1 = this.http.get(this.url + "Mobile_Dashboard/chartdata").map(function (res) { return res.json(); });
        x1.subscribe(function (data) {
            // var data=res.json();
            ...
            data.chart.forEach(function (element) {
                _this.database.insertData(qry, [
                    element.ID_CHART,
                    element.BULAN,
                    element.TAHUN,
    ...
    * Author    : ptr.nov@gmail.com
    */
    DashboardAllProvider.prototype.getMapData = function () {
        var _this = this;
        // var x1=this.http.get(this.url + "/dashboard/get_chart_project_summary").map(res => res.json());
        var x1 = this.http.get(this.url + "Mobile_Dashboard/dshmap").map(function (res) { return res.json(); });
        x1.subscribe(function (data) {
            // var data=res.json();
            ...
            data.Release.forEach(function (element) {
                _this.database.insertData(qry, [
                    element.grp,
                    element.project_id,
                    element.area,
    ...
    * Author    : ptr.nov@gmail.com
    */
    DashboardAllProvider.prototype.getMapB2s = function () {
        var _this = this;
        // var x1=this.http.get(this.url + "/dashboard/get_chart_project_summary").map(res => res.json());
        var x1 = this.http.get(this.url + "Mobile_Dashboard/mapb2s").map(function (res) { return res.json(); });
        x1.subscribe(function (data) {
            // var data=res.json();
    ...
    * Author    : ptr.nov@gmail.com
    */
    DashboardAllProvider.prototype.getMapCore = function () {
        var _this = this;
        // var x1=this.http.get(this.url + "/dashboard/get_chart_project_summary").map(res => res.json());
        var x1 = this.http.get(this.url + "Mobile_Dashboard/dshMap").map(function (res) { return res.json(); });
        x1.subscribe(function (data) {
    ...
    * Author    : ptr.nov@gmail.com
    */
    DashboardAllProvider.prototype.getMapMcp = function () {
        var _this = this;
        // var x1=this.http.get(this.url + "/dashboard/get_chart_project_summary").map(res => res.json());
        var x1 = this.http.get(this.url + "Mobile_Dashboard/mapmicrocell").map(function (res) { return res.json(); });
        x1.subscribe(function (data) {
            // var data=res.json();
    ...
    * Author    : ptr.nov@gmail.com
    */
    DashboardAllProvider.prototype.getMapSp = function () {
        var _this = this;
        // var x1=this.http.get(this.url + "/dashboard/get_chart_project_summary").map(res => res.json());
        var x1 = this.http.get(this.url + "Mobile_Dashboard/mapsp").map(function (res) { return res.json(); });
        x1.subscribe(function (data) {
            // var data=res.json();
    ...
    DashboardAllProvider.prototype.getMitraList = function () {
        ...
        x1.subscribe(function (data) {
            ...
            data.mitra.forEach(function (element) {
                _this.database.insertData(qry, [
                    element.VENDOR_ID,
                    element.VENDOR_NM
                ]);
    ...
    DashboardAllProvider.prototype.getUser = function () {
        var _this = this;
        // var x1=this.http.get(this.url + "/dashboard/get_chart_project_summary").map(res => res.json());
        var x1 = this.http.get(this.url + "Mobile_Dashboard/listuser").map(function (res) { return res.json(); });
        x1.subscribe(function (data) {
            // var data=res.json();
   ...
   */
    ...
    //   });
    // }
    DashboardAllProvider.prototype.postData = function (credentials) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Headers */]();
            // this.http.get("http://192.168.100.3/" + "Mobile_Dashboard/login/"+ credentials)
            _this.http.get(_this.url + "Mobile_Dashboard/login/" + credentials)
    ...
    DashboardAllProvider.prototype.postDatax = function (activity, credentials) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Headers */]();
            // this.http.get("http://192.168.100.3/" + "Mobile_Dashboard/login/"+ credentials)
            _this.http.get(_this.url + activity + credentials)
                .subscribe(function (res) {
                resolve(res.json());
            }, function (err) {
                reject(err);
    ...
    DashboardAllProvider.prototype.postApiMap = function (activity, credentials) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Headers */]();
            // this.http.get("http://192.168.100.3/" + "Mobile_Dashboard/login/"+ credentials)
            var rslt = _this.http.get(_this.url + activity + credentials).map(function (res) { return res.json(); });
            rslt.subscribe(function (data) {
                resolve(data);
            }, function (err) {
                reject(err);
            });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__app_module__ = __webpack_require__(376);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ionic_native_sqlite__ = __webpack_require__(263);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ionic_native_status_bar__ = __webpack_require__(267);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ionic_native_splash_screen__ = __webpack_require__(268);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ionic_native_keyboard__ = __webpack_require__(269);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_ionic_select_searchable__ = __webpack_require__(418);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__services_activity_service__ = __webpack_require__(419);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__ionic_storage__ = __webpack_require__(84);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__app_component__ = __webpack_require__(424);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__pages_settings_settings__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__pages_checkout_trip_checkout_trip__ = __webpack_require__(282);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__pages_home_home__ = __webpack_require__(61);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__pages_login_login__ = __webpack_require__(85);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__pages_notifications_notifications__ = __webpack_require__(436);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__pages_register_register__ = __webpack_require__(270);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__pages_search_location_search_location__ = __webpack_require__(437);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__pages_trip_detail_trip_detail__ = __webpack_require__(283);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__pages_trips_trips__ = __webpack_require__(438);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__pages_local_weather_local_weather__ = __webpack_require__(439);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__providers_rest_rest__ = __webpack_require__(450);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__pages_dsh1_second_norelease_dsh1_second_norelease__ = __webpack_require__(273);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__pages_dsh1_second_prjonpipe_dsh1_second_prjonpipe__ = __webpack_require__(274);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__pages_dsh1_second_rfi_dsh1_second_rfi__ = __webpack_require__(275);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__pages_dsh1_second_afterrfi_dsh1_second_afterrfi__ = __webpack_require__(276);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28__pages_dsh2_home_dsh2_home__ = __webpack_require__(277);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_29__pages_dsh3_home_dsh3_home__ = __webpack_require__(278);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_30__pages_dsh4_home_dsh4_home__ = __webpack_require__(279);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_31__pages_dsh5_home_dsh5_home__ = __webpack_require__(280);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_32__pages_dsh6_home_dsh6_home__ = __webpack_require__(281);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_33__pages_dsh7_home_dsh7_home__ = __webpack_require__(451);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_34__pages_dsh7_modal_flow_dsh7_modal_flow__ = __webpack_require__(452);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_35__swimlane_ngx_datatable__ = __webpack_require__(453);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_35__swimlane_ngx_datatable___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_35__swimlane_ngx_datatable__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_36__providers_database_database__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_37__providers_dashboard_all_dashboard_all__ = __webpack_require__(34);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_3__angular_core__["NgModule"])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_24__pages_dsh1_second_norelease_dsh1_second_norelease__["a" /* Dsh1SecondNoreleasePage */],
                __WEBPACK_IMPORTED_MODULE_25__pages_dsh1_second_prjonpipe_dsh1_second_prjonpipe__["a" /* Dsh1SecondPrjonpipePage */],
                __WEBPACK_IMPORTED_MODULE_26__pages_dsh1_second_rfi_dsh1_second_rfi__["a" /* Dsh1SecondRfiPage */],
                __WEBPACK_IMPORTED_MODULE_27__pages_dsh1_second_afterrfi_dsh1_second_afterrfi__["a" /* Dsh1SecondAfterrfiPage */],
                __WEBPACK_IMPORTED_MODULE_28__pages_dsh2_home_dsh2_home__["a" /* Dsh2HomePage */],
                __WEBPACK_IMPORTED_MODULE_29__pages_dsh3_home_dsh3_home__["a" /* Dsh3HomePage */],
                __WEBPACK_IMPORTED_MODULE_30__pages_dsh4_home_dsh4_home__["a" /* Dsh4HomePage */],
                __WEBPACK_IMPORTED_MODULE_31__pages_dsh5_home_dsh5_home__["a" /* Dsh5HomePage */],
                __WEBPACK_IMPORTED_MODULE_32__pages_dsh6_home_dsh6_home__["a" /* Dsh6HomePage */],
                __WEBPACK_IMPORTED_MODULE_33__pages_dsh7_home_dsh7_home__["a" /* Dsh7HomePage */],
                __WEBPACK_IMPORTED_MODULE_34__pages_dsh7_modal_flow_dsh7_modal_flow__["a" /* Dsh7ModalFlowPage */]
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_0__angular_platform_browser__["BrowserModule"],
                __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["b" /* HttpClientModule */],
                __WEBPACK_IMPORTED_MODULE_2__angular_http__["c" /* HttpModule */],
                __WEBPACK_IMPORTED_MODULE_35__swimlane_ngx_datatable__["NgxDatatableModule"],
                __WEBPACK_IMPORTED_MODULE_4_ionic_angular__["IonicModule"].forRoot(__WEBPACK_IMPORTED_MODULE_12__app_component__["a" /* MyApp */], {
                    scrollPadding: false,
                    scrollAssist: true,
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_37__providers_dashboard_all_dashboard_all__["a" /* DashboardAllProvider */],
                __WEBPACK_IMPORTED_MODULE_36__providers_database_database__["a" /* DatabaseProvider */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__mock_activities__ = __webpack_require__(420);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__pages_dsh2_home_dsh2_home__ = __webpack_require__(277);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__pages_dsh3_home_dsh3_home__ = __webpack_require__(278);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__pages_dsh4_home_dsh4_home__ = __webpack_require__(279);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__pages_dsh5_home_dsh5_home__ = __webpack_require__(280);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__pages_dsh6_home_dsh6_home__ = __webpack_require__(281);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
 ...
 */
var MyApp = (function () {
    function MyApp(platform, statusBar, splashScreen, keyboard, config, events) {
        var _this = this;
        this.platform = platform;
        ...
        this.events.subscribe('profileLogin', function (data) {
            console.log("profile login=", data['login']);
            _this.profileData = data['login'];
        });
        this.initializeApp();
        this.appMenuItems = [
            { id: 'side-button[0]', title: 'All Mitratel Project', component: __WEBPACK_IMPORTED_MODULE_5__pages_home_home__["a" /* HomePage */], icon: 'ios-list', color: 'light' },
            { id: 'side-button[1]', title: 'Build To Suit', component: __WEBPACK_IMPORTED_MODULE_7__pages_dsh2_home_dsh2_home__["a" /* Dsh2HomePage */], icon: 'ios-checkmark-circle-outline', color: 'light' },
            { id: 'side-button[2]', title: 'Colocation & Reseller ', component: __WEBPACK_IMPORTED_MODULE_8__pages_dsh3_home_dsh3_home__["a" /* Dsh3HomePage */], icon: 'ios-checkmark-circle-outline', color: 'light' },
            { id: 'side-button[3]', title: 'Microcell ', component: __WEBPACK_IMPORTED_MODULE_9__pages_dsh4_home_dsh4_home__["a" /* Dsh4HomePage */], icon: 'ios-checkmark-circle-outline', color: 'light' },
            { id: 'side-button[4]', title: 'Special Project ', component: __WEBPACK_IMPORTED_MODULE_10__pages_dsh5_home_dsh5_home__["a" /* Dsh5HomePage */], icon: 'ios-checkmark-circle-outline', color: 'light' },
            { id: 'side-button[5]', title: 'Mitra ', component: __WEBPACK_IMPORTED_MODULE_11__pages_dsh6_home_dsh6_home__["a" /* Dsh6HomePage */], icon: 'ios-checkmark-circle-outline', color: 'light' },
        ];
    }
    /**
    ...
    MyApp.prototype.openPage = function (page) {
        ...
        page.color = "light";
        for (var _i = 0, _a = this.appMenuItems; _i < _a.length; _i++) {
            var p = _a[_i];
...
var GET_STRING_TABLE = [
    ...
    },
    {
        ...
        TABEL: "CREATE TABLE IF NOT EXISTS APPSETTING (SORT TEXT,NAME TEXT,NILAI TEXT,STT_ACTIVE REAL)",
    ...
    },
    {
        ...
        TABEL: "CREATE TABLE IF NOT EXISTS TBL_PETA(GRP TEXT,PROJECT_ID TEXT,AREA TEXT,LAT REAL,LONG REAL,RADIUS REAL,SITE_NM text,TENAN_NM text,REGIONAL text,SOW text,STATUS text)",
        UNIQUE: "CREATE UNIQUE INDEX IF NOT EXISTS TBL_PETA_UNIQ_ID ON TBL_PETA (GRP,PROJECT_ID,AREA)",
    },
    {
        ID: 10,
        NAME: "CREATE MAP B2S",
        TABEL: "CREATE TABLE IF NOT EXISTS TBL_PETA_B2S(GRP TEXT,PROJECT_ID TEXT,AREA TEXT,LAT REAL,LONG REAL,RADIUS REAL,SITE_NM text,TENAN_NM text,REGIONAL text,SOW text,STATUS text)",
        UNIQUE: "CREATE UNIQUE INDEX IF NOT EXISTS TBL_PETA_B2S_UNIQ_ID ON TBL_PETA_B2S (GRP,PROJECT_ID,AREA)",
    },
    {
        ID: 11,
        NAME: "CREATE MAP CORE ROJECT",
        TABEL: "CREATE TABLE IF NOT EXISTS TBL_PETA_CORE(grp TEXT,project_id TEXT,area TEXT,lat REAL,long REAL,radius REAL,site_nm text,tenan_nm text,regional text,sow text,status text)",
        UNIQUE: "CREATE UNIQUE INDEX IF NOT EXISTS TBL_PETA_CORE_UNIQ_ID ON TBL_PETA_CORE (grp,project_id,area)",
    },
    {
        ID: 12,
        NAME: "CREATE MAP MICROCELL ROJECT",
        TABEL: "CREATE TABLE IF NOT EXISTS TBL_PETA_MCP(GRP TEXT,PROJECT_ID TEXT,AREA TEXT,LAT REAL,LONG REAL,RADIUS REAL,SITE_NM text,TENAN_NM text,REGIONAL text,SOW text,STATUS text)",
        UNIQUE: "CREATE UNIQUE INDEX IF NOT EXISTS TBL_PETA_MCP_UNIQ_ID ON TBL_PETA_MCP (GRP,PROJECT_ID,AREA)",
    },
    {
        ID: 13,
        NAME: "CREATE MAP SPECIAL PROJECT",
        TABEL: "CREATE TABLE IF NOT EXISTS TBL_PETA_SP(GRP TEXT,PROJECT_ID TEXT,AREA TEXT,LAT REAL,LONG REAL,RADIUS REAL,SITE_NM text,TENAN_NM text,REGIONAL text,SOW text,STATUS text)",
        UNIQUE: "CREATE UNIQUE INDEX IF NOT EXISTS TBL_PETA_SP_UNIQ_ID ON TBL_PETA_SP (GRP,PROJECT_ID,AREA)",
    },
    {
        ID: 14,
        NAME: "CREATE USER",
        ...
        UNIQUE: "CREATE UNIQUE INDEX IF NOT EXISTS TBL_USER_UNIQ_ID ON TBL_USER (USER_ID,USERNAME)",
    },
    {
        ID: 15,
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_weather__ = __webpack_require__(440);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs_operators__ = __webpack_require__(152);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_rxjs_add_operator_do__ = __webpack_require__(150);
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return Dsh7ModalFlowPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(10);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
...
/**
 * Generated class for the Dsh7ModalFlowPage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var Dsh7ModalFlowPage = (function () {
    function Dsh7ModalFlowPage(navCtrl, navParams) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
    }
    Dsh7ModalFlowPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad Dsh7ModalFlowPage');
    };
    Dsh7ModalFlowPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-dsh7-modal-flow',template:/*ion-inline-start:"E:\ionicProject\MP_Dashboard\MP_Dashboard\src\pages\dsh7-modal-flow\dsh7-modal-flow.html"*/'<!--\n  Generated template for the Dsh7ModalFlowPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>Dsh7ModalFlow</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n\n</ion-content>\n'/*ion-inline-end:"E:\ionicProject\MP_Dashboard\MP_Dashboard\src\pages\dsh7-modal-flow\dsh7-modal-flow.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["NavController"], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["NavParams"]])
    ], Dsh7ModalFlowPage);
    return Dsh7ModalFlowPage;
}());

//# sourceMappingURL=dsh7-modal-flow.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_dashboard_all_dashboard_all__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_database_database__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__dsh1_second_norelease_dsh1_second_norelease__ = __webpack_require__(273);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__dsh1_second_prjonpipe_dsh1_second_prjonpipe__ = __webpack_require__(274);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__dsh1_second_rfi_dsh1_second_rfi__ = __webpack_require__(275);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__dsh1_second_afterrfi_dsh1_second_afterrfi__ = __webpack_require__(276);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_highcharts__ = __webpack_require__(50);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_rxjs_add_observable_interval__ = __webpack_require__(35);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_rxjs_add_observable_timer__ = __webpack_require__(36);
...
// var marker = [];
var dsh1_charting;
var mapStt_RFI = false;
var mapStt_Release = false;
var mapStt_NotRelease = false;
var mapStt_area;
var mapArrayStt = [
    { nama: "RFI", value: false },
    { nama: "RELEASE", value: false },
...
var HomePage = (function () {
    ...
    function HomePage(platform, 
        ...
        navCtrl, popoverCtrl, dashboarAll, alertCtrl, modalCtrl, database, menu, loadingCtrl, config, events, toastCtrl) {
        var _this = this;
        this.platform = platform;
        this.navCtrl = navCtrl;
    ...
    HomePage.prototype.ngOnInit = function () {
        ...
        /** MAP */
        setTimeout(function () {
            _this.dsh1_UpdateCard();
            _this.dsh1_UpdateDataChart();
            _this.dsh1_UpdateDataMap().then(function (data) {
                if (data == true) {
                    localStorage.setItem('dsh1SttMap', '1');
                    _this.spinnerMap.dismiss();
                    _this.spinnerMap.onDidDismiss(function () {
                        var toastBerhasil = _this.toastCtrl.create({
    ...
    /** MAP Button */
    HomePage.prototype.loadMapClick = function () {
        var _this = this;
        console.log("elSttMapButton=", elSttMapButton);
        var elMapButton = document.getElementById("map-button");
        switch (elSttMapButton) {
            case 0:
                var prepareData = this.prepareMapLocalstorage();
                prepareData.then(function (data) {
                    _this.spinnerPrepareMap.dismiss();
                    _this.spinnerPrepareMap.onDidDismiss(function () {
                        spinnerCopyMap = _this.loadingCtrl.create({
                            // cssClass:"map-spinner",
                            spinner: 'bubbles',
                        ...
                        setTimeout(function () {
                            _this.copyMapLocalstorage(data).then(function (dataCopy) {
                                spinnerCopyMap.onDidDismiss(function () {
                                    var toastBerhasil = _this.toastCtrl.create({
    ...
    HomePage.prototype.prepareMapLocalstorage = function () {
        var _this = this;
        ...
        return new Promise(function (resolve) {
            _this.dashboarAll.postApiMap("Mobile_Dashboard/dshAllmap", "").then(function (result) {
                resolve(result);
            });
        });
    };
    HomePage.prototype.copyMapLocalstorage = function (data) {
        var _this = this;
        return new Promise(function (resolve) {
            var itemsProcessed = 0;
            var qry = "INSERT OR REPLACE INTO TBL_PETA(project_id,area,lat,long,radius,site_name,nama_tenant,regional,sow,release_status,target_rfi,progress_status,pf_code,flag_mitra,from_pmo,flag_ventura) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
            data.allMap.forEach(function (el, index, array) {
                itemsProcessed++;
    ...
    */
    ...
    HomePage.prototype.dsh1_InitChart = function () {
        ...
        dsh1_charting = __WEBPACK_IMPORTED_MODULE_9_highcharts__["chart"]({
            chart: {
    ...
    HomePage.prototype.dsh1_UpdateCard = function ($param) {
        var _this = this;
        if ($param === void 0) { $param = '0/0000'; }
        var ary_Header = [];
        var rsltAry = [];
        ...
        //               +" ORDER BY SEQ,GRP DESC,URUTAN ASC";
        //   this.database.selectData(querySql).then(data=>{
        this.dashboarAll.postDatax("Mobile_Dashboard/dshAll/", $param).then(function (result) {
            _this.responseData = result;
            console.log("length=", _this.responseData.length);
            rsltAry = [];
    ...
    HomePage.prototype.rfiChange = function (event) {
        ...
        this.responseData = [];
        this.dsh1_UpdateDataMap().then(function (data) {
            if (data == true) {
                _this.spinnerMap.dismiss();
                _this.spinnerMap.onDidDismiss(function () {
                    var toastBerhasil = _this.toastCtrl.create({
    ...
    HomePage.prototype.releaseChange = function (event) {
        var _this = this;
        var objIndex;
        // this.dsh1_initMap(sqlWhere);
        objIndex = mapArrayStt.findIndex((function (obj) { return obj.nama == "RELEASE"; }));
    ...
    HomePage.prototype.notReleaseChange = function (event) {
        var _this = this;
        var objIndex;
        objIndex = mapArrayStt.findIndex((function (obj) { return obj.nama == "NOTRELEASE"; }));
        //Log object to Console.
    ...
    HomePage.prototype.areaChange = function (event) {
        var _this = this;
        // console.log(event);
        var objIndex;
        var intOption;
    ...
    HomePage.prototype.dsh1_UpdateDataMap = function (qryWhere) {
        var _this = this;
        if (qryWhere === void 0) { qryWhere = null; }
        var rsltAryMap = [];
        var myRFI;
        ...
        return new Promise(function (resolve) {
            if (sttMap == 0) {
                ...
                var cntRow;
                var inc = 0;
                _this.dashboarAll.postDatax("Mobile_Dashboard/dshmap", "").then(function (result) {
                    _this.responseData = result;
                    responseDataCheck.push(result);
                    cntRow = _this.responseData.length;
                    console.log("length=", _this.responseData.length);
                    ...
                    _this.spinnerMap.dismiss();
                    _this.spinnerMap.onDidDismiss(function () {
                        var toastError = _this.toastCtrl.create({
...
var LoginPage = (function () {
    function LoginPage(nav, forgotCtrl, menu, toastCtrl, database, dashboarAll, config, events) {
        this.nav = nav;
    ...
    LoginPage.prototype.login = function () {
        var _this = this;
        var toastSukses = this.toastCtrl.create({
            message: 'wait a moment',
            duration: 3000,
            position: 'middle'
        });
        this.dashboarAll.postData(this.userData.username + "/" + this.userData.password).then(function (result) {
            _this.responseData = result;
            if (_this.responseData.login) {
                console.log(_this.responseData);
                if (_this.responseData.login[0]['STATUS'] != false) {
                    toastSukses.present();
                    toastSukses.onDidDismiss(function () {
                        localStorage.setItem('profile', JSON.stringify(_this.responseData));
                        _this.config.set('real_name', _this.responseData.login[0]['real_name']);
                        _this.config.set('user_group', _this.responseData.login[0]['user_group']);
                        _this.events.publish('profileLogin', _this.responseData);
                        _this.nav.setRoot(__WEBPACK_IMPORTED_MODULE_2__home_home__["a" /* HomePage */]);
                    });
                }
                else {
                    _this.salahUserPasswordToast();
                }
            }
        }, function (err) {
            _this.koneksiMasalahToast();
            console.log("jaringan bermasalah");
        });
        // this.nav.setRoot(HomePage);
    };
    LoginPage.prototype.salahUserPasswordToast = function () {
        var toast = this.toastCtrl.create({
    ...
    LoginPage.prototype.koneksiMasalahToast = function () {
        var toast = this.toastCtrl.create({
