    ...
    Dsh2HomePage.prototype.getData = function () {
        ...
        this.database.selectData(querySql).then(function (data) {
            ...
            if (rsltAry[0].length !== 0) {
                ...
                aryB2S_AREA_PRJ_ON_PIPE[0].forEach(function (el) {
                    console.log(el);
